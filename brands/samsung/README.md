...
In the past, there have been hardware issues caused by unlocking the boatloader, but these have been fixed in certain regions. See [here][1] and [here][2]. As of late 2023, Kroean Galaxy Z Fold3 still got camera function disabled after unlocking.
